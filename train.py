...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning_rate', required=False, type=float, default=1.0e-05)
    ...
    parser.add_argument('--auto_encoder_embedding', required=False, default='tmp/reversal_auto_encoder_5000_1000_250.pt')
    ...
    parser.add_argument('--attff_input_size', required=False, type=int, default=1250)
    parser.add_argument('--attff_hidden_size', required=False, type=int, default=10)
    parser.add_argument('--ae_model_file', required=False, default='tmp/reversal_auto_encoder_5000_1000_250.pt')
