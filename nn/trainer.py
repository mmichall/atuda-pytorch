...
class DomainAdaptationTrainer:
    ...
    def fit(self, training_generator, validation_generator, target_generator):
        ...
        self._fit(training_generator, target_generator, max_epochs=20, is_step2=True)
        ...
        for epoch in range(max_epochs):
            ...
            for idx, batch_one_hot, labels, src in data_loader:
                ...
                if is_step2:
                    ...
                    _acc1 = acc(f1, labels)
                    _acc_all1 += _acc1
                    _loss_mean1 = round(loss_all1 / batch_num, 4)

                    _acc2 = acc(f2, labels)
                    _acc_all2 += _acc2
                    _loss_mean2 = round(loss_all2 / batch_num, 4)

                    sys.stdout.write(
                        '\r### F1:  Epoch {}, Batch {}, train loss: {} , acc: {} ### | ### F2:  Epoch {}, Batch {}, train loss: {} , acc: {} ###'.format(
                            epoch, batch_num,
                            _loss_mean1,
                            round(
                                _acc_all1 / batch_num,
            ...
            self.scheduler.step(_loss_mean1, epoch)
